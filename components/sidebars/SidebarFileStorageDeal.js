  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <img
          src="/static/test-image-upload.jpg"
          className={STYLES_IMAGE_PREVIEW}
        />

        <div className={STYLES_ITEM}>
          <div className={STYLES_FOCUS}>test-image-upload.jpg</div>
          <div className={STYLES_SUBTEXT}>Name</div>
        </div>

        <div className={STYLES_ITEM}>
          <div className={STYLES_FOCUS}>42 MB</div>
          <div className={STYLES_SUBTEXT}>File size</div>
        </div>
        ...
        <div className={STYLES_ITEM}>
          <div className={STYLES_FOCUS}>2 FIL</div>
          <div className={STYLES_SUBTEXT}>Last order price</div>
        </div>
