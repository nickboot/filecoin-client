...
const Item = ({
  ...
  return (
    ...
    >
      <span
        className={STYLES_EXPANDER}
        onClick={onToggleShow ? onToggleShow : null}
      >
        <span
          className={STYLES_ICON_ELEMENT}
          style={{
      ...
      <span className={STYLES_ICON} onClick={() => onNavigateTo({ id }, data)}>
        <span
          className={STYLES_ICON_ELEMENT}
          style={{
            color: activeIds[id] ? Constants.system.brand : null,
