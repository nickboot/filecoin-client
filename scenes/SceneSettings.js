  ...
  render() {
    return (
      <ScenePage>
        ...
        <div className={STYLES_GROUP} style={{ marginTop: 32 }}>
        ...
        <System.Input
          ...
          value={this.state.settings_deal_default_duration}
        ...
        <System.Input
          ...
          value={this.state.settings_deal_maximum_storage_payment}
        ...
        <System.Input
          ...
          value={this.state.settings_deal_replication_factor}
        ...
        <System.Textarea
          value={this.state.settings_deal_default_miners}
        ...
        <System.SelectMenu
          ...
          value={this.state.settings_deal_country}
          onChange={this._handleChange}
          options={SELECT_MENU_OPTIONS}
        >
          {SELECT_MENU_MAP[this.state.settings_deal_country]}
        </System.SelectMenu>
        ...
        <System.Input
          ...
          value={this.state.settings_deal_password}
